...
on:
  schedule:
    # Previa 10:31 Arg - principal
    - cron: '31 13 * * 1-6'
    # Matutina 12:36 Arg - principal
    - cron: '36 15 * * *'
    # Vespertina 15:31 Arg - principal
    - cron: '31 18 * * *'
    # Tardecita 20:01 Arg - principal
    - cron: '1 23 * * 1-6'
    # Nocturna 22:31 Arg - principal (lun a vie)
    - cron: '31 1 * * 2-6'
    # Nocturna 22:31 Arg - principal (sabado)
    - cron: '31 1 * * 0'
    # Previa 11:10 Arg - refuerzo
    - cron: '10 14 * * 1-6'
    # Matutina 13:10 Arg - refuerzo
    - cron: '10 16 * * *'
    # Vespertina 16:10 Arg - refuerzo
    - cron: '10 19 * * *'
    # Tardecita 20:40 Arg - refuerzo
    - cron: '40 23 * * 1-6'
    # Nocturna 23:10 Arg - refuerzo (lun a vie)
    - cron: '10 2 * * 2-6'
    # Nocturna 23:10 Arg - refuerzo (sabado)
    - cron: '10 2 * * 0'
    # Cierre 23:45 Arg - manda lo que falte del dia
    - cron: '45 2 * * *'
  workflow_dispatch:
        ...
        run: |
          ...
          def main():
              ...
              if "--auto" in args:
                  ...
                  # Muy lejos de cualquier sorteo: mando el resumen.
                  if distancia > 120:
                      print(
                  ...
                  # Corrida de cierre (23:45 Arg): mando lo que haya quedado pendiente.
                  if distancia > 60:
                      print(
                          "Corrida de cierre (%d min del horario): "
                          "reviso si falto algun sorteo del dia." % distancia
                      )
          ...
          def enviar_pendientes():
              """Manda los sorteos de hoy que todavia no se enviaron (corrida de cierre)."""
              hoy = fecha_arg()
              try:
                  sorteos = parse_tombola(fetch(URL_SORTEOS_HOY))
              except Exception as e:
              ...
              faltan = [s for s in sorteos if s["nombre"] not in enviados]
              if not faltan:
